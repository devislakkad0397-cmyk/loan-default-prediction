...
from api.schemas import LoanPredictionInput, PredictionResponse
...
class DecisionTreePredictor(BaseModelPredictor):
    ...
    def __init__(self, pkl_path: str = None):
        ...
        if pkl_path is None:
            ...
            self.pkl_path = current_dir.parent / "model_files" / "DecisionTreeModel.pkl"
        else:
    ...
    def preprocess(self, data: LoanPredictionInput) -> List[List[float]]:
        """
